...
const WhatsAppQRCode = () => {
  ...
  const updateQRCode = () => {
    ...
    const data = `https://wa.me/${countryCode}${phoneNumber}?text=${encodeURIComponent(message)}`;
    ...
    <div className="container mt-3">
      <div className="row">
        <div className="col-lg-6">
          <div className="my-3">
            <h3>Submit WhatsApp Information</h3>
            ...
            <small className="form-text text-muted my-2">
              Your QR code will open a WhatsApp chat with this content.
            </small>
          </div>
          <div>
            <Accordion>
